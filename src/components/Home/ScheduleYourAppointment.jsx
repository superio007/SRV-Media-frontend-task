      ...
      >
        <div className="flex flex-col container mx-auto gap-10">
          <div className="flex flex-col gap-3">
            ...
            <h2 className="bg-linear-to-t from-[#000E38] to-[#3F186A] text-transparent bg-clip-text text-6xl">
      ...
      >
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-3">
            ...
            <h2 className="bg-linear-to-t from-[#000E38] to-[#3F186A] text-transparent bg-clip-text text-3xl">
              Pre-schedule Your <br /> School Appointments
            </h2>
            <p className="bg-linear-to-t from-[#755797] to-[#9B4DF0] text-lg text-1.5 bg-clip-text text-transparent">
              To Avoid Rush
